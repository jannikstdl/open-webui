...
app.state.config.ENABLE_KNOWLEDGE_GRAPH = ENABLE_KNOWLEDGE_GRAPH
app.state.config.GRAPH_DB = GRAPH_DB
app.state.config.NEO4J_URI = NEO4J_URI
app.state.config.NEO4J_USER = NEO4J_USER
app.state.config.NEO4J_PASSWORD = NEO4J_PASSWORD
app.state.config.KG_SEARCH_MODE = KG_SEARCH_MODE
app.state.config.KG_ENTITY_EXTRACT_MAX_GLEANING = KG_ENTITY_EXTRACT_MAX_GLEANING

# Multimodal RAG settings
app.state.config.ENABLE_MULTIMODAL_RAG = ENABLE_MULTIMODAL_RAG
app.state.config.MULTIMODAL_PROCESS_IMAGES = MULTIMODAL_PROCESS_IMAGES
app.state.config.MULTIMODAL_PROCESS_TABLES = MULTIMODAL_PROCESS_TABLES
app.state.config.MULTIMODAL_PROCESS_EQUATIONS = MULTIMODAL_PROCESS_EQUATIONS
app.state.config.ENABLE_VLM_ENHANCED_RETRIEVAL = ENABLE_VLM_ENHANCED_RETRIEVAL
app.state.config.VLM_MODEL = VLM_MODEL
app.state.config.VLM_BASE_URL = VLM_BASE_URL
app.state.config.VLM_API_KEY = VLM_API_KEY
