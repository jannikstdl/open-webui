...
# FI-TS_custom 2026-01-12: Channel LLM context control settings
app.state.config.CHANNEL_LLM_MAX_MESSAGES = CHANNEL_LLM_MAX_MESSAGES
app.state.config.CHANNEL_LLM_MAX_TOKENS = CHANNEL_LLM_MAX_TOKENS
# FI-TS_custom 2026-01-15: Configurable channel prompts
app.state.config.CHANNEL_SYSTEM_PROMPT = CHANNEL_SYSTEM_PROMPT
app.state.config.CHANNEL_DECISION_PROMPT = CHANNEL_DECISION_PROMPT
...
app.state.config.RETRIEVAL_QUERY_GENERATION_PROMPT_TEMPLATE = RETRIEVAL_QUERY_GENERATION_PROMPT_TEMPLATE
