<div class="bg-white dark:bg-gray-950">
	<div
		class="mx-auto max-w-7xl divide-y divide-gray-900/10 dark:divide-gray-700 px-6 py-24 sm:py-32 lg:px-8 lg:py-40"
	>
		<h2 class="text-2xl font-bold leading-10 tracking-tight text-gray-900 dark:text-gray-200">
		...
		<dl class="mt-10 space-y-8 divide-y divide-gray-900/10 dark:divide-gray-700">
			...
			<div class="pt-8 lg:grid lg:grid-cols-12 lg:gap-8">
				<dt
					class="text-base font-semibold leading-7 text-gray-900 dark:text-gray-200 lg:col-span-5"
				>
					Auf welcher Hardware laufen die Modelle?
				</dt>
				<dd class="mt-4 lg:col-span-7 lg:mt-0">
					<p class="text-base leading-7 text-gray-600 dark:text-gray-300">
