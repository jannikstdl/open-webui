	...
	<div class="overflow-y-auto h-screen">
		<div class="bg-white dark:bg-gray-950 min-h-screen w-full flex justify-center items-center font-mona">
			<div class="w-full sm:max-w-md px-10 flex flex-col text-center">
				...
				{:else}
					<!-- Auth ist aktiv, also normale Anzeige -->
					<div class="my-auto pb-10 w-full dark:text-gray-100">
						{#if !showAdminForm}
							<!-- Initial: nur Oauth Button + Administrativer Login Button -->
							...
							<button
								class="mt-6 text-sm rounded-2xl border border-gray-300 dark:border-gray-700 py-2 px-4 text-gray-600 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 transition"
